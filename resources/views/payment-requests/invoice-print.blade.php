                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="mb-3 d-flex">
                                ...
                                <div class="col-8" style="text-align: justify;">{{ $pr->company->company ?? '-' }}</div>
                            </div>
                            <div class="mb-3 d-flex">
                                <div class="col-3 fw-bold">TRUCK</div>
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8" style="text-align: justify;">{{ $invoice->truck ?? '-' }}</div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="mb-3 d-flex">
                                ...
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8">{{ $invoice->invoice_date ? $invoice->invoice_date->format('d/m/Y') : '-' }}</div>
                            </div>
                            <div class="mb-3 d-flex">
                                <div class="col-3 fw-bold">INVOICE NUMBER</div>
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8" style="text-align: justify;">{{ $invoice->invoice_number }}</div>
                            </div>
                            <div class="mb-3 d-flex">
                                <div class="col-3 fw-bold">DELIVERY DATE</div>
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8">{{ $invoice->delivery_date ? $invoice->delivery_date->format('d/m/Y') : '-' }}</div>
                            </div>
                        </div>
                            ...
                            <table id="c-tool-ele" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-wrap" style="max-width: 360px;">{{ $value->detail }}</td>
                                        <td class="text-center">{{ number_format($value->qty, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ $value->uom->uom ?? '-' }}</td>
                                        <td class="text-center">{{ $symbol }} {{ number_format($value->price, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ $symbol }} {{ number_format($value->discount, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ $symbol }} {{ number_format($value->tax1, 2, ',', '.') }}</td>
                                        <td class="text-center">{{ $symbol }} {{ number_format($value->tax2, 2, ',', '.') }}</td>
                                        <td class="fw-bold">{{ $symbol }} {{ number_format($value->ammount, 2, ',', '.') }}</td>
                                    </tr>
                                    @endforeach
                                    @if(count($detail) == 0)
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th colspan="1">{{ $symbol }} {{ number_format($discount, 0, ',', '.') }}</th>
                                    </tr>
                                    <tr>
                                        <th colspan="8" style="text-align: right; background-color: darkseagreen;">TOTAL PAYMENT</th>
                                        <th colspan="1">{{ $symbol }} {{ number_format($grandTotal, 0, ',', '.') }}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="mb-3 d-flex">
                                ...
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8">{{ $bankName }}</div>
                            </div>
                            <div class="mb-3 d-flex">
                                <div class="col-3 fw-bold">ACCOUNT NAME</div>
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8">{{ $bankHolder }}</div>
                            </div>
                            <div class="mb-3 d-flex">
                                <div class="col-3 fw-bold">ACCOUNT NUMBER</div>
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8">{{ $bankAccount }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <div class="text-start" style="margin-right: 120px;">
                                <!-- Vendor -->
                                <div class="fw-bold">{{ $pr->vendor->vendor ?? 'VENDOR' }}</div>
                                <!-- Garis pertama -->
                                <div style="border-bottom: 1px solid #000; width: auto; margin: 4px 0;"></div>
                                <div class="fw-bold">NAME :</div>
                            </div>
