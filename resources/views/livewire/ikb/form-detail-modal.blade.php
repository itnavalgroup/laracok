                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <select x-model="form.id_item_category" class="form-select select2-ikb-detail"
                            id="ikb_detail_category" {{ $isInvCtrlEditMode ?? false ? 'disabled' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <select x-model="form.id_packaging" class="form-select select2-ikb-detail"
                            id="ikb_detail_packaging" {{ $isInvCtrlEditMode ?? false ? 'disabled' : '' }}>
                        ...
                        <div class="col-md-12">
                            ...
                            <select x-model="form.id_contract" class="form-select select2-ikb-detail"
                                ...
                                @foreach ($contracts as $contract)
                                    <option value="{{ $contract->id_contract }}">{{ $contract->contract_number }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
