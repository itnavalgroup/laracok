    ...
    <div class="login-container">
        ...
        <div class="login-form">
            <div class="logo-container mb-4 text-center">
                <img src="{{ asset('assets/images/logo-dashboard.png') }}" alt="Logo" class="img-fluid" style="max-height: 60px;">
            </div>
            ...
            <div class="text-center mt-3">
                <a href="{{ asset('documentation/index.html') }}" class="btn btn-outline-secondary border-0 rounded-pill px-4">
                    <i class="ti ti-book me-2"></i> Lihat Dokumentasi
                </a>
            </div>

            <div class="footer-text text-center mt-5 text-muted small">
                <p class="mb-0">&copy; {{ date('Y') }} Naval Group. All rights reserved.</p>
            </div>
        </div>
    </div>
