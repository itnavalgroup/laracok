    ...
    <div>
        <div class="card border-0 shadow-lg" style="border-radius: 12px;"
            ...
            <div class="card-header bg-primary text-white py-3">
                ...
                <a href="{{ route('settlement-reports.index') }}" class="btn-close btn-close-white" aria-label="Close"></a>
            </div>
        ...
        function srFormData() {
            return {
                ...
                async submitForm() {
                    ...
                    this.saving = true;
                    try {
                        const result = await @this.saveFromJs(this.form, this.srId);
