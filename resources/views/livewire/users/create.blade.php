                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('id_employee') is-invalid @enderror" wire:model="id_employee" placeholder="e.g. SBB-0000">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group @if(!$loop->last) mb-2 @endif">
                                        ...
                                        <input type="email" class="form-control @error('emails.'.$index) is-invalid @enderror" wire:model="emails.{{ $index }}" placeholder="example@navalgroup.com">
                                        @if(count($emails) > 1)
                                    ...
                                    @error('emails.'.$index) <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                                    @endforeach
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('id_position') is-invalid @enderror" wire:model="id_position">
                            ...
                            <div class="card mb-3 border shadow-none bg-light-subtle rounded-3 overflow-hidden bank-account-card">
                                <div class="card-body p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h6 class="mb-0 fw-bold text-primary small">REKENING #{{ $index + 1 }}</h6>
                                        <button type="button" class="btn btn-sm btn-light text-danger rounded-circle p-0" style="width: 28px; height: 28px;" wire:click="removeBankAccount({{ $index }})">
                                            <i class="ti ti-trash"></i>
                                        </button>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-white" wire:model="bankAccounts.{{ $index }}.nama_bank" placeholder="e.g. OCB / BCA">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-white" wire:model="bankAccounts.{{ $index }}.nama_penerima" placeholder="Full Name">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-white" wire:model="bankAccounts.{{ $index }}.norek" placeholder="Number only">
