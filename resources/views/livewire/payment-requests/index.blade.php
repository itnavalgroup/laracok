                                ...
                                <div class="col-md-4">
                                    ...
                                    <select wire:model.live="filterDepartement"
                                        ...
                                        @foreach ($departements as $dept)
                                            <option value="{{ $dept->id_departement }}">{{ $dept->departement }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select wire:model.live="filterCompany"
                                    ...
                                    @foreach ($companies as $company)
                                        <option value="{{ $company->id_company }}">{{ $company->company_name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                            ...
                                            <li>
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input" style="cursor: pointer;"
                                                        ...
                                                        value="{{ $val }}" id="chk-pr-{{ $val }}">
                                                    <label class="form-check-label w-100 d-block"
                                                        style="cursor: pointer;" for="chk-pr-{{ $val }}">
                                                        {{ $label }}
                                                    </label>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input" style="cursor: pointer;"
                                                        ...
                                                        value="{{ $val }}" id="chk-sr-{{ $val }}">
                                                    <label class="form-check-label w-100 d-block"
                                                        style="cursor: pointer;" for="chk-sr-{{ $val }}">
                                                        {{ $label }}
                                                    </label>
                                                </div>
                                            </li>
                        ...
                        @forelse($prs as $pr)
                            <tr wire:key="pr-{{ $pr->id_pr }}">
                                <td class="text-center text-muted small">
                                    {{ ($prs->currentPage() - 1) * $prs->perPage() + $loop->iteration }}</td>
                                <td>
                                    @php
                                        $docTypes = [
                                    ...
                                    @endphp
                                    <span
                                        class="badge bg-light-{{ $docType['color'] }} text-{{ $docType['color'] }} mb-1 w-100">{{ $docType['name'] }}</span>
                                    <span
                                        class="badge bg-light-{{ $paymentType['color'] }} text-{{ $paymentType['color'] }} w-100">{{ $paymentType['name'] }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="text-muted small mb-1">
                                        <i
                                            class="ti ti-layout-grid me-1"></i>{{ $pr->departement->departement ?? 'N/A' }}
                                    </div>
                                ...
                                <td>
                                    ...
                                    <div class="text-muted small"><i
                                            class="ti ti-building-bank me-1"></i>{{ $namaBank }}</div>
                                ...
                                <td class="text-end">
                                    ...
                                    @else
                                        ...
                                        <div
                                            class="small d-flex justify-content-between mt-1 {{ $srBalance > 0 ? 'text-danger' : ($srBalance < 0 ? 'text-primary' : 'text-success') }}">
                                            <span>Balance:</span>
                                ...
                                <td class="text-center">
                                    ...
                                    @endphp
                                    <span
                                        class="badge bg-light-{{ $badge['color'] }} text-{{ $badge['color'] }}">{{ $badge['label'] }}</span>
                                    ...
                                    @if ($pr->id_doc_type == 2 && $pr->status >= 8 && $pr->status <= 11)
                                        ...
                                        <br>
                                        <span
                                            class="badge bg-light-{{ $srBadge['color'] }} text-{{ $srBadge['color'] }} mt-1">SR:
                                            {{ $srBadge['label'] }}</span>
                                    @endif
                                </td>
                                <td class="text-center">
