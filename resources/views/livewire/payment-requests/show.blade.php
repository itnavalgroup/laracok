        ...
        <div class="col-12 mb-4 d-none">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('payment-requests.index') }}"
            ...
            <div class="card p-4 border-0 shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-start mb-4 border-bottom pb-3"
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('payment-requests.index') }}" class="btn btn-secondary btn-sm"
                                data-html2canvas-ignore="true">
                                <i class="ti ti-arrow-left me-1"></i> Back
                            </a>
                            @if ($showPayment || $canPayment)
                                <a href="{{ route('payment-requests.payment', $prHash) }}"
                            ...
                            @if ($isAdmin || $isOwner || $user->hasPermission('pr_invoice.view') || $user->hasPermission('pr_invoice.create'))
                                <a href="{{ route('payment-requests.invoice', $prHash) }}"
                            ...
                            @if ($canEdit)
                                <button type="button"
                                    wire:click="$dispatch('open-pr-form', { id: {{ $pr->id_pr }} })"
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div style="width: 30%;">
                        ...
                        @if (file_exists($logoFullPath))
                            <img src="{{ asset('assets/companies/logos/' . $logoPath) }}" class="img-fluid"
                ...
                <div class="row pt-2">
                    <div class="alert alert-success d-flex align-items-center mb-4" role="alert"
                        ...
                        <div class="mx-3">
                            <span class="badge bg-{{ $sbadge['color'] == 'warning' ? 'warning' : $sbadge['color'] }}"
                                style="font-size:11px; padding: 4px 8px; {{ $sbadge['color'] == 'warning' ? 'color: #000;' : '' }}">{{ $sbadge['label'] }}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                            ...
                            <div class="col-1 text-end">:&nbsp;</div>
                            <div class="col-8">
                                {{ $pr->payment_due_date ? \Carbon\Carbon::parse($pr->payment_due_date)->format('d F Y') : '-' }}
                            </div>
                        </div>
                        @if (in_array($pr->id_doc_type, [2, 3]))
                            <div class="mb-3 d-flex" style="font-size: 13px;">
                                ...
                                <div class="col-1 text-end">:&nbsp;</div>
                                <div class="col-8">
                                    {{ $pr->est_settlement_date ? \Carbon\Carbon::parse($pr->est_settlement_date)->format('d F Y') : '-' }}
                                </div>
                            </div>
                        @endif
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                    ...
                    <div class="form-group col-md-6">
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                            ...
                            <div class="col-1 text-end">:&nbsp;</div>
                            <div class="col-8">
                                {{ $pr->id_doc_type != 3 ? $pr->docType->doc_type ?? '-' : 'Settlement' }}</div>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                            ...
                            <div class="col-1 text-end">:&nbsp;</div>
                            <div class="col-8">
                                {{ $pr->payment_type_pr == 1 ? 'Parsial' : ($pr->payment_type_pr == 2 ? 'Full Payment' : 'Full Payment') }}
                            </div>
                        </div>
                        ...
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                            ...
                            <div class="col-1 text-end">:&nbsp;</div>
                            <div class="col-8">{{ $pr->nama_penerima ?: $pr->norek_vendor->nama_penerima ?? '' }}
                            </div>
                        </div>
                        <div class="mb-3 d-flex" style="font-size: 13px;">
                    ...
                    <table class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            @forelse($pr->details as $item)
                                <tr>
                                    ...
                                    <td class="text-wrap"
                                        style="max-width: 360px; cursor: {{ $canViewDetail ? 'pointer' : 'default' }};"
                                        @if ($canViewDetail) wire:click="$dispatchTo('payment-requests.form-detail-modal', 'openModal', { id: {{ $item->id_detail_pr }}, viewOnly: true })" @endif>
                                        {{ $item->detail }}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @if (!empty($item->taxSatu) && $item->tax1 > 0)
                                            {{ $item->taxSatu->tax }}
                                            ({{ number_format($item->taxSatu->tax_persen * 100, 2, ',', '.') }}%)<br>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($item->tax2 > 0)
                                            {{ $item->taxDua->tax ?? '' }}
                                            ({{ number_format(($item->taxDua->tax_persen ?? 0) * 100, 2, ',', '.') }}%)<br>
                                            {{ $symbol }} {{ number_format($item->tax2, 2, ',', '.') }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                    <td class="fw-bold">{{ $symbol }}
                            ...
                            @empty
                                ...
                                <tr>
                                    <td colspan="{{ $showActionColumn ? 11 : 10 }}" class="text-center py-3">Tidak
                                        ada item.</td>
                                </tr>
                            @endforelse
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <th colspan="1">{{ $symbol }}
                                    {{ number_format($pr->additional_discount ?? 0, 2, ',', '.') }}</th>
                                @if ($showActionColumn ?? $canEditDetail && in_array($pr->status, [null, 0, 12]))
                            ...
                            <tr>
                                <th colspan="9" style="text-align:right; background-color: darkseagreen;">GRAND
                                    TOTAL</th>
                                <th colspan="1">{{ $symbol }} {{ number_format($grandTotal, 2, ',', '.') }}
                                </th>
                                @if ($showActionColumn ?? $canEditDetail && in_array($pr->status, [null, 0, 12]))
                                    <th data-html2canvas-ignore="true"></th>
                                @endif
                            ...
                            <tr>
                                ...
                                <th colspan="1">{{ $symbol }} {{ number_format($balance, 2, ',', '.') }}
                                </th>
                                @if ($showActionColumn ?? $canEditDetail && in_array($pr->status, [null, 0, 12]))
                                    <th data-html2canvas-ignore="true"></th>
                                @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="id_attachment" id="edit_id_attachment"
                                            ...
                                            @foreach (\App\Models\Attachment::orderBy('attachment')->get() as $type)
                                                <option value="{{ $type->id_attachment }}">{{ $type->attachment }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <form id="formAddAttachment" method="POST"
                                action="{{ route('payment-requests.attachment.store', $prHash) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" name="id_attachment">
                                            ...
                                            @foreach (\App\Models\Attachment::orderBy('attachment')->get() as $att)
                                                <option value="{{ $att->id_attachment }}">{{ $att->attachment }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 mb-4">
                            ...
                            <div class="border-bottom mx-auto position-relative image-container"
                                ...
                                @if ($s1)
                                    ...
                                    @endphp
                                    <div class="pt-2">
                                        <img src="{{ $this->getQr($qrText1) }}" class="signature-img"
                            ...
                            <div class="mt-2 fw-bold small {{ $s1 ? 'text-uppercase' : '' }}"
                                style="font-size: 14px;">{{ $s1?->user?->name ?? 'User' }}</div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 mb-4">
                            ...
                            <div class="border-bottom mx-auto position-relative image-container"
                                ...
                                @if ($s2)
                                    ...
                                    @endphp
                                    <div class="pt-2">
                                        <img src="{{ $this->getQr($qrText2) }}" class="signature-img"
                                            style="height: 80px; width: 80px; object-fit: contain; display: block; margin: 0 auto;">
                                    </div>
                                @endif
                            ...
                            <div class="mt-2 fw-bold small {{ $s2 ? 'text-uppercase' : '' }}"
                                style="font-size: 14px;">{{ $s2?->user?->name ?? 'Department Head' }}</div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 mb-4">
                            ...
                            <div class="border-bottom mx-auto position-relative image-container"
                                ...
                                @if ($s3)
                                    ...
                                    @endphp
                                    <div class="pt-2">
                                        <img src="{{ $this->getQr($qrText3) }}" class="signature-img"
                                            style="height: 80px; width: 80px; object-fit: contain; display: block; margin: 0 auto;">
                                    </div>
                                @endif
                            ...
                            <div class="mt-2 fw-bold small {{ $s3 ? 'text-uppercase' : '' }}"
                                style="font-size: 14px;">{{ $s3?->user?->name ?? 'Director' }}</div>
                        </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-3 mb-4">
                                ...
                                <div class="border-bottom mx-auto position-relative image-container"
                                    ...
                                    @if ($s4)
                                        ...
                                        @endphp
                                        <div class="pt-2">
                                            <img src="{{ $this->getQr($qrText4) }}" class="signature-img"
                                                style="height: 80px; width: 80px; object-fit: contain; display: block; margin: 0 auto;">
                                        </div>
                                    @endif
                                ...
                                <div class="mt-2 fw-bold small {{ $s4 ? 'text-uppercase' : '' }}"
                                    style="font-size: 14px;">{{ $s4?->user?->name ?? 'Accounting' }}</div>
                            </div>
                        @endif
                            ...
                            <div class="col-12 col-sm-6 col-md-4 mb-4">
                                ...
                                <div class="border-bottom mx-auto position-relative image-container"
                                    ...
                                    @if ($s5)
                                        ...
                                        @endphp
                                        <div class="pt-2">
                                            <img src="{{ $this->getQr($qrText5) }}" class="signature-img"
                                                style="height: 80px; width: 80px; object-fit: contain; display: block; margin: 0 auto;">
                                        </div>
                                    @endif
                                ...
                                <div class="mt-2 fw-bold small {{ $s5 ? 'text-uppercase' : '' }}"
                                    style="font-size: 14px;">{{ $s5?->user?->name ?? 'Finance Staff' }}</div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 mb-4">
                                ...
                                <div class="border-bottom mx-auto position-relative image-container"
                                    ...
                                    @if ($s6)
                                        ...
                                        @endphp
                                        <div class="pt-2">
                                            <img src="{{ $this->getQr($qrText6) }}" class="signature-img"
                                                style="height: 80px; width: 80px; object-fit: contain; display: block; margin: 0 auto;">
                                        </div>
                                    @endif
                                ...
                                <div class="mt-2 fw-bold small {{ $s6 ? 'text-uppercase' : '' }}"
                                    style="font-size: 14px;">{{ $s6?->user?->name ?? 'Finance Supervisor' }}</div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 mb-4">
                                ...
                                <div class="border-bottom mx-auto position-relative image-container"
                                    ...
                                    @if ($s7)
                                        ...
                                        @endphp
                                        <div class="pt-2">
                                            <img src="{{ $this->getQr($qrText7) }}" class="signature-img"
                                                style="height: 80px; width: 80px; object-fit: contain; display: block; margin: 0 auto;">
                                        </div>
                                    @endif
                                ...
                                <div class="mt-2 fw-bold small {{ $s7 ? 'text-uppercase' : '' }}"
                                    style="font-size: 14px;">{{ $s7?->user?->name ?? 'Chief Finance Officer' }}</div>
                            </div>
