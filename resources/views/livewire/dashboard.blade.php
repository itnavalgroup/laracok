<div wire:poll.30s>
    ...
    <div class="dash-welcome-card mb-4 p-4 rounded-4 shadow-sm d-flex align-items-center justify-content-between flex-wrap gap-3"
        ...
        <div class="text-end">
            <div class="badge rounded-pill px-3 py-2 fs-6" style="background: rgba(255,255,255,0.2);">
                ...
                {{ $user->level === 1 ? 'Administrator' : ($user->position->position ?? 'User') }}
            </div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
        {{-- Card 1: PR Pending Persetujuan (status 1-6) --}}
                ...
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-baseline gap-2">
                            <h5 class="fw-bold text-white mb-0" style="font-size:1.6rem; line-height:1;">{{ number_format($stats['prPendingApprovalCount']) }}</h5>
                            <span class="text-white" style="font-size:.75rem; opacity:.8;">PR</span>
                        </div>
                        <p class="mb-0" style="color:#fff; font-size:.82rem; font-weight:600;">{{ 'Rp ' . number_format($stats['nilaiPrPendingApproval'], 0, ',', '.') }}</p>
        ...
        {{-- Card 2: PR Pending Pembayaran (status 7-10, 14, 15) --}}
        <div class="col-6 col-md-3">
            <div class="card h-100 border-0 shadow-sm dash-stat-card" style="border-radius:14px; background: linear-gradient(135deg,#5E35B1,#7E57C2);">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-baseline gap-2">
                            <h5 class="fw-bold text-white mb-0" style="font-size:1.6rem; line-height:1;">{{ number_format($stats['prPendingPaymentCount']) }}</h5>
                            <span class="text-white" style="font-size:.75rem; opacity:.8;">PR</span>
                        </div>
                        <p class="mb-0" style="color:#fff; font-size:.82rem; font-weight:600;">{{ 'Rp ' . number_format($stats['nilaiPrPendingPayment'], 0, ',', '.') }}</p>
        ...
        {{-- Card 3: PR Selesai Lunas (status 11) --}}
        <div class="col-6 col-md-3">
            <div class="card h-100 border-0 shadow-sm dash-stat-card" style="border-radius:14px; background: linear-gradient(135deg,#1565C0,#1976D2);">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-2">
                        <div class="d-flex align-items-baseline gap-2">
                            <h5 class="fw-bold text-white mb-0" style="font-size:1.6rem; line-height:1;">{{ number_format($stats['prSelesaiCount']) }}</h5>
                            <span class="text-white" style="font-size:.75rem; opacity:.8;">PR</span>
                        </div>
                        <p class="mb-0 fw-bold" style="color:#fff; font-size:.82rem; margin-top:2px;">{{ 'Rp ' . number_format($stats['nilaiPrSelesai'], 0, ',', '.') }}</p>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-1">
                            ...
                            <span class="fw-bold" style="color:#FFF9C4; font-size:.75rem;">
                                Rp {{ number_format($stats['prSelesaiOverpaid'], 0, ',', '.') }}
                            </span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-1">
                            <span style="color:rgba(255,255,255,0.75); font-size:.72rem;">
                            ...
                            <span class="fw-bold" style="color:#FFCDD2; font-size:.75rem;">
                                Rp {{ number_format($stats['prSelesaiUnderpaid'], 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
        ...
        {{-- Card 4: PR Bayar Sebagian (Detail Status 8) --}}
        <div class="col-6 col-md-3">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-1">
                            ...
                            <span class="fw-bold" style="color:#A5D6A7; font-size:.8rem;">
                                Rp {{ number_format($stats['totalTerbayarParsial'], 0, ',', '.') }}
                            </span>
                        </div>
                        <hr style="border-color:rgba(255,255,255,0.2); margin:6px 0;">
                        {{-- Sisa Belum Dibayar --}}
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold" style="color:#FFF9C4; font-size:.8rem;">
                                Rp {{ number_format($stats['sisaTagihanParsial'], 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
    ...
    {{-- =========================================================== --}}
    {{-- SR MONITORING STATS (SR = Laporan Pertanggungjawaban Anggaran) --}}
    {{-- =========================================================== --}}
    <div class="row g-3 mb-4">
        {{-- Card 1: SR Pending Persetujuan (status 1-6) - count + nilai --}}
        <div class="col-6 col-md-3">
            <div class="card h-100 border-0 shadow-sm dash-stat-card" style="border-radius:14px; background: linear-gradient(135deg,#E65100,#FF6D00);">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-baseline gap-2">
                            <h5 class="fw-bold text-white mb-0" style="font-size:1.6rem; line-height:1;">{{ number_format($stats['srPendingApprovalCount']) }}</h5>
                            <span class="text-white" style="font-size:.75rem; opacity:.8;">SR</span>
                        </div>
                        <p class="mb-0" style="color:#fff; font-size:.82rem; font-weight:600;">{{ 'Rp ' . number_format($stats['nilaiSrPendingApproval'], 0, ',', '.') }}</p>
        ...
        {{-- Card 2: SR Pending Settlement (status 7,8,9) - count + nilai --}}
        <div class="col-6 col-md-3">
            <div class="card h-100 border-0 shadow-sm dash-stat-card" style="border-radius:14px; background: linear-gradient(135deg,#6A1B9A,#8E24AA);">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-baseline gap-2">
                            <h5 class="fw-bold text-white mb-0" style="font-size:1.6rem; line-height:1;">{{ number_format($stats['srPendingSettlementCount']) }}</h5>
                            <span class="text-white" style="font-size:.75rem; opacity:.8;">SR</span>
                        </div>
                        <p class="mb-0" style="color:#fff; font-size:.82rem; font-weight:600;">{{ 'Rp ' . number_format($stats['nilaiSrPendingSettlement'], 0, ',', '.') }}</p>
        ...
        {{-- Card 3: SR Selesai (status 10,11) - count + nilai --}}
        <div class="col-6 col-md-3">
            <div class="card h-100 border-0 shadow-sm dash-stat-card" style="border-radius:14px; background: linear-gradient(135deg,#2E7D32,#43A047);">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <div class="d-flex align-items-baseline gap-2">
                            <h5 class="fw-bold text-white mb-0" style="font-size:1.6rem; line-height:1;">{{ number_format($stats['srSelesaiCount']) }}</h5>
                            <span class="text-white" style="font-size:.75rem; opacity:.8;">SR</span>
                        </div>
                        <p class="mb-0" style="color:#fff; font-size:.82rem; font-weight:600;">{{ 'Rp ' . number_format($stats['nilaiSrSelesai'], 0, ',', '.') }}</p>
        ...
        {{-- Card 4: Settlement - kembalian karyawan vs tambahan perusahaan --}}
        <div class="col-6 col-md-3">
            <div class="card h-100 border-0 shadow-sm dash-stat-card" style="border-radius:14px; background: linear-gradient(135deg,#00695C,#00897B);">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-2">
                        ...
                        {{-- Kembalian dari karyawan (SR realisasi < dana PR) --}}
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            <span style="color:rgba(255,255,255,0.75); font-size:.72rem;">
                                <i class="ti ti-arrow-narrow-left me-1"></i>Kembalian Karyawan
                            </span>
                            <span class="fw-bold" style="color:#A5D6A7; font-size:.8rem;">
                                Rp {{ number_format($stats['totalKembalianKaryawan'], 0, ',', '.') }}
                            </span>
                        </div>
                        {{-- Tambahan dari perusahaan (SR realisasi > dana PR) --}}
                        <div class="d-flex justify-content-between align-items-center mt-1">
                            <span style="color:rgba(255,255,255,0.75); font-size:.72rem;">
                                <i class="ti ti-arrow-narrow-right me-1"></i>Tambahan Perusahaan
                            </span>
                            <span class="fw-bold" style="color:#FFCC80; font-size:.8rem;">
                                Rp {{ number_format($stats['totalTambahanPerusahaan'], 0, ',', '.') }}
                            </span>
                        </div>
                        <hr style="border-color:rgba(255,255,255,0.2); margin:6px 0;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold text-white" style="font-size:.8rem;">
                                Rp {{ number_format($stats['totalKembalianKaryawan'] + $stats['totalTambahanPerusahaan'], 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm dash-stat-card" style="border-radius:10px; background: #fff;">
                <div class="card-body p-2 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark" style="font-size:0.9rem;">{{ number_format($stats['totalPr']) }}</h6>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm dash-stat-card" style="border-radius:10px; background: #fff;">
                <div class="card-body p-2 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark" style="font-size:0.9rem;">{{ number_format($stats['pendingPr']) }}</h6>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm dash-stat-card" style="border-radius:10px; background: #fff;">
                <div class="card-body p-2 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark" style="font-size:0.9rem;">{{ number_format($stats['totalSr']) }}</h6>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm dash-stat-card" style="border-radius:10px; background: #fff;">
                <div class="card-body p-2 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark" style="font-size:0.9rem;">{{ number_format($stats['pendingSr']) }}</h6>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm dash-stat-card" style="border-radius:10px; background: #fff;">
                <div class="card-body p-2 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark" style="font-size:0.75rem;">{{ number_format($stats['totalPrValue']) }}</h6>
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="card border-0 shadow-sm dash-stat-card" style="border-radius:10px; background: #fff;">
                <div class="card-body p-2 d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark" style="font-size:0.9rem;">{{ number_format($stats['totalItThisMonth']) }}</h6>
    ...
    <div class="card border-0 shadow-sm" style="border-radius:14px;">
        <div class="card-header border-0 p-0" style="background: transparent; border-radius: 14px 14px 0 0;">
            <ul class="nav nav-tabs nav-fill dashboard-tabs" id="pendingTabs" role="tablist" style="border-bottom: 1px solid #eee;">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'all' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'all')" type="button">
                        <i class="ti ti-list-details me-1"></i>
                        SEMUA
                        @if($tabCounts['all'] > 0)
                        <span class="badge rounded-pill bg-danger ms-1">{{ $tabCounts['all'] }}</span>
                        @endif
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'PR' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'PR')" type="button">
                        <i class="ti ti-file-description me-1"></i>
                        PR
                        @if($tabCounts['PR'] > 0)
                        <span class="badge rounded-pill bg-primary ms-1">{{ $tabCounts['PR'] }}</span>
                        @endif
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'SR' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'SR')" type="button">
                        <i class="ti ti-file-analytics me-1"></i>
                        SR
                        @if($tabCounts['SR'] > 0)
                        <span class="badge rounded-pill bg-success ms-1">{{ $tabCounts['SR'] }}</span>
                        @endif
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'IKB' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'IKB')" type="button">
                        <i class="ti ti-box me-1"></i>
                        IKB
                        @if($tabCounts['IKB'] > 0)
                        <span class="badge rounded-pill bg-warning ms-1 text-dark">{{ $tabCounts['IKB'] }}</span>
                        @endif
                    </button>
                </li>
                {{-- MONITORING TABS (separator) --}}
                <li class="nav-item d-flex align-items-center" role="presentation">
                    <div style="width:1px; height:28px; background:#dee2e6; margin: 0 4px;"></div>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'pr_payment_full' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'pr_payment_full')" type="button">
                        <i class="ti ti-cash me-1"></i>
                        PR Lunas
                        @if(($tabCounts['pr_payment_full'] ?? 0) > 0)
                        <span class="badge rounded-pill ms-1" style="background:#0277BD; color:#fff;">{{ $tabCounts['pr_payment_full'] }}</span>
                        @endif
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'pr_partial_payment' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'pr_partial_payment')" type="button">
                        <i class="ti ti-receipt-2 me-1"></i>
                        PR Parsial
                        @if(($tabCounts['pr_partial_payment'] ?? 0) > 0)
                        <span class="badge rounded-pill ms-1" style="background:#5E35B1; color:#fff;">{{ $tabCounts['pr_partial_payment'] }}</span>
                        @endif
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link py-3 {{ $activeTab === 'sr_pending_settlement' ? 'active' : '' }}"
                        wire:click="$set('activeTab', 'sr_pending_settlement')" type="button">
                        <i class="ti ti-arrows-exchange me-1"></i>
                        SR Settlement
                        @if(($tabCounts['sr_pending_settlement'] ?? 0) > 0)
                        <span class="badge rounded-pill ms-1" style="background:#00695C; color:#fff;">{{ $tabCounts['sr_pending_settlement'] }}</span>
                        @endif
                    </button>
                </li>
            </ul>
        ...
        <div class="card-body p-0">
            @if(in_array($activeTab, ['all','PR','SR','IKB']))
            {{-- APPROVAL TABLE --}}
            <div class="px-4 py-2 border-bottom bg-light d-flex align-items-center justify-content-between">
                <span class="small fw-bold text-uppercase text-muted">
                    ...
                    Perlu Tindakan Saya ({{ $activeTab }})
                </span>
                <span class="text-muted small">Menampilkan {{ $pendingItems->count() }} dari {{ $pendingItems->total() }} data</span>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="dash-approval-row" style="cursor:pointer;"
                            onclick="window.location='{{ route($item['route'], $item['hash']) }}'">
                            <td class="ps-4">
                                <span class="badge rounded-pill px-3 py-2 fw-bold"
                                    style="background: {{ $badgeBg }}; color:#fff; font-size:.75rem; letter-spacing:.5px;">
                                    <i class="ti {{ $item['icon'] }} me-1"></i>{{ $item['type'] }}
                                </span>
                            </td>
                            <td><span class="fw-semibold text-dark">{{ $item['number'] }}</span></td>
                            <td>
                                <span class="text-muted" style="max-width:300px; display:block; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
                                    {{ $item['subject'] }}
                                </span>
                            </td>
                            <td><span class="text-muted small">{{ $item['date'] ? \Carbon\Carbon::parse($item['date'])->format('d M Y') : '-' }}</span></td>
                            <td>
                                <span class="badge rounded-pill px-3 py-1"
                                    style="background:{{ $statusBg }}22; color:{{ $statusBg }}; border:1px solid {{ $statusBg }}44; font-size:.75rem;">
                                    {{ $statusText }}
                                </span>
                            </td>
                            <td class="pe-4 text-end">
                                <a href="{{ route($item['route'], $item['hash']) }}"
                                    class="btn btn-sm rounded-pill px-3 fw-semibold"
                                    style="background: {{ $badgeBg }}; color:#fff; font-size:.75rem;"
            ...
            @elseif($activeTab === 'pr_payment_full')
            {{-- PR PENDING PAYMENT FULL TABLE --}}
            <div class="px-4 py-2 border-bottom d-flex align-items-center justify-content-between" style="background:#E3F2FD;">
                <span class="small fw-bold text-uppercase" style="color:#0277BD;">
                    <i class="ti ti-cash me-1"></i>
                    PR Pending Payment (Tipe Full / Lunas Sekaligus) — {{ $tabCounts['pr_payment_full'] }} dokumen
                </span>
            </div>
            @if($prFullPaymentItems->isEmpty())
            <div class="text-center py-5">
                <i class="ti ti-circle-check" style="font-size:3.5rem;color:#22c55e;"></i>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach($prFullPaymentItems as $pr)
                        <tr class="dash-approval-row" style="cursor:pointer;"
                            onclick="window.location='{{ route('payment-requests.show', hashid_encode($pr->id_pr,'pr')) }}'">
                            <td class="ps-4">
                                <span class="fw-bold" style="color:#0277BD;">{{ $pr->pr_number ?? 'Draft' }}</span>
                                <br><small class="text-muted">{{ Str::limit($pr->subject, 35) }}</small>
                            </td>
                            <td><span class="text-dark">{{ optional($pr->vendor)->vendor ?? '-' }}</span></td>
                            <td><span class="text-dark">{{ optional($pr->user)->name ?? '-' }}</span></td>
                            <td class="text-end">
                                <span class="fw-semibold">Rp {{ number_format($pr->total_tagihan, 0, ',', '.') }}</span>
                            </td>
                            <td class="pe-4 text-end">
                                <a href="{{ route('payment-requests.show', hashid_encode($pr->id_pr,'pr')) }}"
                                    class="btn btn-sm rounded-pill px-3 fw-semibold"
            ...
            @if($prFullPaymentItems instanceof \Illuminate\Pagination\LengthAwarePaginator && $prFullPaymentItems->hasPages())
            <div class="px-4 py-3 border-top d-flex align-items-center justify-content-between">
                <span class="text-muted small">Menampilkan {{ $prFullPaymentItems->firstItem() }}&ndash;{{ $prFullPaymentItems->lastItem() }} dari {{ $prFullPaymentItems->total() }} data</span>
                <div class="d-flex gap-2">
                    @if($prFullPaymentItems->currentPage() > 1)
                    <button wire:click="$set('monitorPage', {{ $prFullPaymentItems->currentPage() - 1 }})" class="btn btn-sm btn-outline-secondary rounded-pill px-3"><i class="ti ti-chevron-left"></i></button>
                    @endif
                    <span class="btn btn-sm btn-primary rounded-pill px-3 disabled">{{ $prFullPaymentItems->currentPage() }} / {{ $prFullPaymentItems->lastPage() }}</span>
                    @if($prFullPaymentItems->hasMorePages())
                    <button wire:click="$set('monitorPage', {{ $prFullPaymentItems->currentPage() + 1 }})" class="btn btn-sm btn-outline-secondary rounded-pill px-3"><i class="ti ti-chevron-right"></i></button>
                    @endif
                </div>
            </div>
            @endif
            ...
            @elseif($activeTab === 'pr_partial_payment')
            {{-- PR PARTIAL PAYMENT TABLE --}}
            <div class="px-4 py-2 border-bottom d-flex align-items-center justify-content-between" style="background:#EDE7F6;">
                <span class="small fw-bold text-uppercase" style="color:#5E35B1;">
                    <i class="ti ti-receipt-2 me-1"></i>
                    PR Bayar Sebagian (Parsial / Termin) — {{ $tabCounts['pr_partial_payment'] }} dokumen
                </span>
            </div>
            @if($prPartialPaymentItems->isEmpty())
            <div class="text-center py-5">
                <i class="ti ti-circle-check" style="font-size:3.5rem;color:#22c55e;"></i>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach($prPartialPaymentItems as $pr)
                        @php
                        ...
                        <tr class="dash-approval-row" style="cursor:pointer;"
                            onclick="window.location='{{ route('payment-requests.show', hashid_encode($pr->id_pr,'pr')) }}'">
                            <td class="ps-4">
                                <span class="fw-bold" style="color:#5E35B1;">{{ $pr->pr_number ?? 'Draft' }}</span>
                                <br><small class="text-muted">{{ Str::limit($pr->subject, 35) }}</small>
                            </td>
                            <td>{{ optional($pr->vendor)->vendor ?? '-' }}</td>
                            <td>{{ optional($pr->user)->name ?? '-' }}</td>
                            <td class="text-end fw-semibold">Rp {{ number_format($tagihan, 0, ',', '.') }}</td>
                            <td class="text-end" style="color:#2E7D32;">Rp {{ number_format($dibayar, 0, ',', '.') }}</td>
                            <td class="text-end fw-bold" style="color:#E53935;">Rp {{ number_format($sisa, 0, ',', '.') }}</td>
                            <td class="pe-4 text-end">
                                <a href="{{ route('payment-requests.show', hashid_encode($pr->id_pr,'pr')) }}"
                                    class="btn btn-sm rounded-pill px-3 fw-semibold"
            ...
            @if($prPartialPaymentItems instanceof \Illuminate\Pagination\LengthAwarePaginator && $prPartialPaymentItems->hasPages())
            <div class="px-4 py-3 border-top d-flex align-items-center justify-content-between">
                <span class="text-muted small">Menampilkan {{ $prPartialPaymentItems->firstItem() }}&ndash;{{ $prPartialPaymentItems->lastItem() }} dari {{ $prPartialPaymentItems->total() }} data</span>
                <div class="d-flex gap-2">
                    @if($prPartialPaymentItems->currentPage() > 1)
                    <button wire:click="$set('monitorPage', {{ $prPartialPaymentItems->currentPage() - 1 }})" class="btn btn-sm btn-outline-secondary rounded-pill px-3"><i class="ti ti-chevron-left"></i></button>
                    @endif
                    <span class="btn btn-sm rounded-pill px-3 disabled" style="background:#5E35B1; color:#fff;">{{ $prPartialPaymentItems->currentPage() }} / {{ $prPartialPaymentItems->lastPage() }}</span>
                    @if($prPartialPaymentItems->hasMorePages())
                    <button wire:click="$set('monitorPage', {{ $prPartialPaymentItems->currentPage() + 1 }})" class="btn btn-sm btn-outline-secondary rounded-pill px-3"><i class="ti ti-chevron-right"></i></button>
                    @endif
                </div>
            </div>
            @endif
            ...
            @elseif($activeTab === 'sr_pending_settlement')
            {{-- SR PENDING SETTLEMENT TABLE --}}
            <div class="px-4 py-2 border-bottom d-flex align-items-center justify-content-between" style="background:#E0F2F1;">
                <span class="small fw-bold text-uppercase" style="color:#00695C;">
                    <i class="ti ti-arrows-exchange me-1"></i>
                    SR Pending Settlement — {{ $tabCounts['sr_pending_settlement'] }} dokumen
                </span>
            </div>
            @if($srSettlementItems->isEmpty())
            <div class="text-center py-5">
                <i class="ti ti-circle-check" style="font-size:3.5rem;color:#22c55e;"></i>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach($srSettlementItems as $sr)
                        @php
                        ...
                        @endphp
                        <tr class="dash-approval-row" style="cursor:pointer;"
                            onclick="window.location='{{ route('settlement-reports.show', hashid_encode($sr->id_pr,'pr')) }}'">
                            <td class="ps-4">
                                <span class="fw-bold" style="color:#00695C;">{{ $sr->pr_number ?? 'SR-'.$sr->id_sr }}</span>
                                <br><small class="text-muted">{{ Str::limit($sr->subject, 35) }}</small>
                            </td>
                            <td>{{ optional($sr->user)->name ?? '-' }}</td>
                            <td class="text-end fw-semibold">Rp {{ number_format($penerimaan, 0, ',', '.') }}</td>
                            <td class="text-end fw-semibold">Rp {{ number_format($dilaporkan, 0, ',', '.') }}</td>
                            <td class="text-end">
                                <span class="badge rounded-pill" style="background:{{ $selisihColor }}22; color:{{ $selisihColor }}; border:1px solid {{ $selisihColor }}55; font-size:.75rem;">
                                    {{ $selisihLabel }}: Rp {{ number_format(abs($selisih), 0, ',', '.') }}
                                </span>
                            </td>
                            <td class="pe-4 text-end">
                                <a href="{{ route('settlement-reports.show', hashid_encode($sr->id_pr,'pr')) }}"
                                    class="btn btn-sm rounded-pill px-3 fw-semibold"
            ...
            @if($srSettlementItems instanceof \Illuminate\Pagination\LengthAwarePaginator && $srSettlementItems->hasPages())
            <div class="px-4 py-3 border-top d-flex align-items-center justify-content-between">
                <span class="text-muted small">Menampilkan {{ $srSettlementItems->firstItem() }}&ndash;{{ $srSettlementItems->lastItem() }} dari {{ $srSettlementItems->total() }} data</span>
                <div class="d-flex gap-2">
                    @if($srSettlementItems->currentPage() > 1)
                    <button wire:click="$set('monitorPage', {{ $srSettlementItems->currentPage() - 1 }})" class="btn btn-sm btn-outline-secondary rounded-pill px-3"><i class="ti ti-chevron-left"></i></button>
                    @endif
                    <span class="btn btn-sm rounded-pill px-3 disabled" style="background:#00695C; color:#fff;">{{ $srSettlementItems->currentPage() }} / {{ $srSettlementItems->lastPage() }}</span>
                    @if($srSettlementItems->hasMorePages())
                    <button wire:click="$set('monitorPage', {{ $srSettlementItems->currentPage() + 1 }})" class="btn btn-sm btn-outline-secondary rounded-pill px-3"><i class="ti ti-chevron-right"></i></button>
                    @endif
                </div>
            </div>
            @endif
