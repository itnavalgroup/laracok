...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_pr_item_transactions', function (Blueprint $table) {
            $table->bigInteger('id_pr_item_transaction')->primary()->unsigned()->autoIncrement();
    ...
    {
        Schema::dropIfExists('tbl_pr_item_transactions');
    }
};
