        ...
        <div class="d-flex align-items-center gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canSubmit): ?>
                <button type="button" class="btn btn-primary btn-sm rounded-pill shadow-sm px-3 fw-bold"
                    onclick="openApprovalModal('approve', <?php echo e($status); ?>)">
                    <i class="ti ti-send me-1"></i> Submit
                </button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canApproveCurrent): ?>
                <button type="button" class="btn btn-success btn-sm rounded-pill shadow-sm px-3 fw-bold"
                    onclick="openApprovalModal('approve', <?php echo e($status); ?>)">
                    <i class="ti ti-check me-1"></i> Approve
                </button>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status < 6): ?>
                    <button type="button" class="btn btn-warning btn-sm rounded-pill shadow-sm px-3 fw-bold"
                        onclick="openApprovalModal('revision', <?php echo e($status); ?>)">
                        <i class="ti ti-refresh me-1"></i> Revision
                    </button>
                    <button type="button" class="btn btn-danger btn-sm rounded-pill shadow-sm px-3 fw-bold"
                        onclick="openApprovalModal('reject', <?php echo e($status); ?>)">
                        <i class="ti ti-x me-1"></i> Reject
                    </button>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCancelCurrent): ?>
                <button type="button"
        ...
        <div class="col-12">
            <div class="card p-3 border-0 shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-start mb-4 border-bottom pb-3">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('ikb.index')); ?>" class="btn btn-secondary btn-sm no-print-btn">Back</a>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditHeader): ?>
                                <button type="button"
                                    wire:click="$dispatch('open-ikb-form', { id: <?php echo e($ikb->id_ikb); ?> })"
                                    class="btn btn-warning btn-sm no-print-btn">Edit</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ikb->qr): ?>
                            <img alt="QR IKB" src="<?php echo e(asset('assets/qr/' . $ikb->qr)); ?>"
                ...
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="text-center" style="flex: 1;">
                        <h4 style="font-weight: 700; color: #3b5998; text-transform: uppercase; margin-bottom: 5px;">
                            <?php echo e($ikb->company->company_name ?? ($ikb->company->company ?? config('app.name'))); ?>
                ...
                <div class="row g-3" style="font-size: 15px;">
                    <div class="col-md-6">
                        <div class="row mb-2">
                            ...
                            <div class="col-7">
                                <span class="badge bg-light-info text-info border px-3" style="font-size: 11px;">
                                    <?php echo e($ikb->transactionType->transaction_type ?? '-'); ?>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->ikb_number ?? 'DRAFT'); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">PO NUMBER</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->po_number ?? '-'); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">SO NUMBER</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->so_number ?? '-'); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">RI NUMBER</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->ri_number ?? '-'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row mb-2">
                            ...
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->created_at->format('d F Y')); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">BOOKING DATE</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->booking_date ? $ikb->booking_date->format('d F Y') : '-'); ?>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-7 d-flex align-items-center gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ikb->delivery_date): ?>
                                    <?php echo e($ikb->delivery_date->format('d F Y')); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canApproveStep8 && $status == 8): ?>
                                        <button class="btn btn-outline-secondary no-print-btn"
                                            style="font-size:10px;padding:1px 6px;"
                                            wire:click="$set('deliveryDate', '<?php echo e($ikb->delivery_date->format('Y-m-d')); ?>')"
                                            data-bs-toggle="modal" data-bs-target="#modalDeliveryDate">Edit</button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php elseif($canApproveStep8 && $status == 8): ?>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-1 text-center">:</div>
                            <div class="col-7 d-flex align-items-center gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ikb->stuffing_date): ?>
                                    <?php echo e($ikb->stuffing_date->format('d F Y')); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canApproveStep6 && $status == 6): ?>
                                        <button class="btn btn-outline-secondary no-print-btn"
                                            style="font-size:10px;padding:1px 6px;"
                                            data-date="<?php echo e($ikb->stuffing_date->format('Y-m-d')); ?>"
                                            data-bs-toggle="modal" data-bs-target="#modalStuffingDate">Edit</button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php elseif($canApproveStep6 && $status == 6): ?>
                                    <button class="btn btn-primary btn-sm no-print-btn"
                                        style="font-size:11px;padding:2px 8px;" data-bs-toggle="modal"
                ...
                <div class="row g-3" style="font-size: 15px;">
                    <div class="col-md-6">
                        <div class="row mb-2 no-print-btn">
                            ...
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->user->name ?? '-'); ?></div>
                        </div>
                        <div class="row mb-2 no-print-btn">
                            <div class="col-4 fw-bold text-uppercase">SALES</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->salesUser->name ?? '-'); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">DEPARTEMENT</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->departement->departement ?? '-'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row mb-2">
                            ...
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->warehouse->warehouse_name ?? '-'); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">CUSTOMER</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->vendor->vendor ?? '-'); ?></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 fw-bold text-uppercase">DESTINATION</div>
                            <div class="col-1 text-center">:</div>
                            <div class="col-7"><?php echo e($ikb->destination ?? '-'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header align-items-center bg-transparent d-flex px-0 py-3 mt-4 border-bottom">
                    ...
                    <div class="d-flex gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($status == 0 || $status == 11) && ($isAdmin || ($isOwner && $user->hasPermission('ikb_detail.create')))): ?>
                            <button class="btn btn-primary btn-sm no-print-btn"
                    ...
                    <table class="table table-bordered table-striped" style="font-size: 15px;">
                        <thead class="text-center" style="background-color: #2e7d32;">
                            <tr>
                                ...
                                <th style="color: rgb(230, 230, 230) !important;">DESCRIPTION</th>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status == 0 || $status == 11 || ($status >= 4 && $status <= 9 && $canEditDetail)): ?>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ikb->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td class="text-center"><?php echo e($index + 1); ?></td>
                                    <td class="text-center"><?php echo e($detail->itemCategory->item_category ?? '-'); ?></td>
                                    <td>
                                        <span class="fw-bold"><?php echo e($detail->item->item_code ?? 'N/A'); ?></span><br>
                                        <?php echo e($detail->item->item_name ?? 'N/A'); ?>

                                    </td>
                                    <td class="text-center fw-bold"><?php echo e(number_format($detail->qty, 2, '.', ',')); ?>

                                    </td>
                                    <td class="text-center"><?php echo e($detail->uom->uom ?? '-'); ?></td>
                                    <td class="text-center"><?php echo e($detail->packaging->packaging ?? '-'); ?></td>
                                    <td class="text-center"><?php echo e($detail->description ?? '-'); ?></td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(
                                        ($status == 0 || $status == 11 || ($status >= 4 && $status <= 9 && $canEditDetail)) &&
                                            ($canEditDetail || $canDeleteDetail)): ?>
                                        <td class="text-center no-print-btn">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditDetail): ?>
                                                <button class="btn btn-link p-0 text-warning me-2" title="Edit Item"
                                                    wire:click="$dispatchTo('ikb.form-detail-modal', 'openModal', { id: <?php echo e($detail->id_ikb_detail); ?> })">
                                                    <i class="ti ti-edit fs-4"></i>
                                                </button>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canDeleteDetail && ($status == 0 || $status == 11)): ?>
                                                <button class="btn btn-link p-0 text-danger" title="Hapus Item"
                                                    onclick="showConfirm({
                                            title: 'Hapus Item',
                                            message: 'Apakah Anda yakin ingin menghapus item ini?',
                                            type: 'danger',
                                            onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').dispatch('delete-detail', { id: <?php echo e($detail->id_ikb_detail); ?> })
                                        })">
                ...
                <div class="row g-3" style="font-size: 15px;">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ikb->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php
                        ...
                        <div class="col-md-2 d-flex align-items-center mb-3">
                            <div class="form-check form-check-inline d-flex align-items-center">
                                ...
                                <label class="form-check-label text-justify flex-grow-1" style="cursor:pointer;">
                                    <?php $attHash = hashid_encode($att->id_attachment_ikb, 'att_ikb'); ?>
                                    <a href="#"
                                        data-url="<?php echo e(asset('assets/attachmentikb/' . $att->filename)); ?>"
                                        data-type="<?php echo e($att->type->attachment ?? 'GENERAL'); ?>"
                                        data-note="<?php echo e($att->note ?? ''); ?>"
                                        data-delete="<?php echo e(route('ikb.attachment.delete', $attHash)); ?>"
                                        data-update="<?php echo e(route('ikb.attachment.update', $attHash)); ?>"
                                        data-catid="<?php echo e($att->id_attachment); ?>"
                                        data-can-edit="<?php echo e($canEditAtt ? 'true' : 'false'); ?>"
                                        onclick="<?php echo e($canViewThisAtt ? 'window.previewAttachment(this)' : 'window.dispatchEvent(new CustomEvent(\'alert\', { detail: { type: \'error\', title: \'Access Denied\', message: \'Anda tidak memiliki izin untuk melihat lampiran ini.\' } }))'); ?>; return false;"
                                        style="color:inherit;text-decoration:none;">
                                        <?php echo e($att->type->attachment ?? ($att->note ?: '-')); ?>
                ...
                <div class="mt-5 pt-4 border-top">
                    ...
                    <div class="row g-3 text-center">
                        ...
                        <div class="col">
                            ...
                            <div class="border-bottom mx-auto position-relative image-container"
                                ...
                                <?php $s0 = $sign(0); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s0): ?>
                                    <?php
                                        $qrText =
                                            'IKB: ' .
                                    ...
                                    ?>
                                    <div class="pt-2">
                                        <img src="<?php echo e($this->getQr($qrText)); ?>"
                                            style="height: 80px; width: 80px; object-fit: contain;">
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status == 1 && ($isAdmin || ($isSales && $user->hasPermission('ikb.cancel_submit')))): ?>
                                        <button type="button"
                            ...
                            <div class="mt-2 fw-bold small text-uppercase" style="font-size: 14px;">
                                <?php echo e($s0->user->name ?? ($ikb->salesUser->name ?? '-')); ?>
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cols; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="col">
                                ...
                                <div class="border-bottom mx-auto position-relative image-container"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status == $col['step'] + 1 && ($isAdmin || $user->id_user == $s->id_user)): ?>
                                            <button type="button"
                                                class="btn btn-outline-danger btn-xs position-absolute top-50 start-50 translate-middle no-print-btn"
                                                onclick="showCancelModal('cancelApproval')">Cancel</button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php elseif($status == $col['step']): ?>
                                        <?php
                                            $canApprove = false;
                                            if ($isAdmin) {
                                                $canApprove = true;
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canApprove): ?>
                                            <div class="d-flex flex-row justify-content-center gap-1 pt-4 px-1 no-print-btn"
                                                ...
                                                <button onclick="openApprovalModal('approve', <?php echo e($col['step']); ?>)"
                                                    class="btn btn-success btn-icon btn-sm" title="Approve"><i
                                                        class="ti ti-check fs-6"></i></button>
                                                <button onclick="openApprovalModal('reject', <?php echo e($col['step']); ?>)"
                                                    class="btn btn-danger btn-icon btn-sm" title="Reject"><i
                                                        class="ti ti-x fs-6"></i></button>
                                                <button onclick="openApprovalModal('revision', <?php echo e($col['step']); ?>)"
                                ...
                                <div class="mt-1 x-small fw-bold"><?php echo e($col['role']); ?></div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                    ...
                    <div class="row g-3 text-center justify-content-center">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cols2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="col-md-2">
                                <div class="fw-bold mb-1 small text-uppercase" style="font-size: 14px;">
                                    <?php echo e($col['title']); ?>
                                ...
                                <div class="border-bottom mx-auto position-relative image-container"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s): ?>
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php elseif($status == $col['step']): ?>
                                        <?php $canApprove = $isAdmin || $user->hasPermission("ikb.approve.step{$col['step']}"); ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canApprove): ?>
                                            <div class="d-flex flex-row justify-content-center gap-1 pt-4 px-1 no-print-btn"
                                ...
                                <div class="mt-1 x-small fw-bold"><?php echo e($col['role']); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($col['step'] == 8 && $status == 8 && ($isAdmin || $user->hasPermission('ikb.approve.step8'))): ?>
            ...
            <?php
                $history = $ikb
                    ...
                    ->get();
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($history->count() > 0 && ($status == 11 || $status == 12)): ?>
                ...
                <div class="table-responsive mb-4 no-print-history">
                    <table class="table table-sm table-bordered table-striped" style="font-size: 11px;">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td class="text-center"><?php echo e($idx + 1); ?></td>
                                    <td class="text-center">
                                        <span class="badge bg-<?php echo e($h->status == 12 ? 'danger' : 'primary'); ?>">
                                            <?php echo e($h->status == 12 ? 'REJECTED' : 'REVISION'); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($h->user->name ?? '-'); ?></td>
                                    <td><?php echo e($h->reject_reason ?? '-'); ?></td>
                                    <td class="text-center"><?php echo e($h->created_at->format('d/m/Y H:i')); ?></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </tbody>
                    </table>
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($approvalNotes->count() > 0 && !in_array($status, [0, 11, 12])): ?>
                ...
                <div class="table-responsive mb-4 no-print-history">
                    <table class="table table-sm table-bordered table-striped" style="font-size: 11px;">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $approvalNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td class="text-center"><?php echo e($idx + 1); ?></td>
                                    <td class="text-center fw-bold"><?php echo e($stepNames[$n->status] ?? 'Unknown'); ?></td>
                                    <td><?php echo e($n->user->name ?? '-'); ?></td>
                                    <td><?php echo e($n->director_reason ?? '-'); ?></td>
                                    <td class="text-center"><?php echo e($n->created_at->format('d/m/Y H:i')); ?></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </tbody>
                    </table>
...
[$__name, $__params] = $__split('ikb.form-modal', []);

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1433400558-4', $key);
...
[$__name, $__params] = $__split('ikb.form-detail-modal', ['ikbId' => $ikb->id_ikb]);

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1433400558-5', $key);
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['stuffingDate'];
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form id="formAddAttachment" method="POST"
                    action="<?php echo e(route('ikb.attachment.store', hashid_encode($ikb->id_ikb, 'ikb'))); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            window.downloadPDF = function() {
                ...
                const options = {
                    margin: 0,
                    filename: 'IKB-<?php echo e($ikb->ikb_number ??
                        '
                                                                                                                                                                    DRAFT '); ?>.pdf',
                    image: {
                        type: 'jpeg',
            ...
            document.getElementById('modalStuffingDate').addEventListener('show.bs.modal', function(e) {
                ...
                if (input) {
                    ...
                    if (dateVal) {
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('stuffingDate', dateVal, false);
                    } else {
            ...
            document.getElementById('modalDeliveryDate').addEventListener('show.bs.modal', function(e) {
                ...
                if (input) {
                    input.value = dateVal || '';
                    if (dateVal) {
                        window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('deliveryDate', dateVal, false);
                    } else {
                        input.dispatchEvent(new Event('input', {
                            bubbles: true
                        }));
            ...
            document.getElementById('btnConfirmApprove').onclick = function() {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').dispatch('processSign', {
                    action: 'approve',
                    step: step,
                    note: note
                });
...
<?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\ikb\show.blade.php ENDPATH**/ ?>