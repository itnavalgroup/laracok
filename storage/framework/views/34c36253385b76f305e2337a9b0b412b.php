                ...
                <div class="col-md-3">
                    <div class="card summary-card bg-primary h-100">
                        <div class="card-body">
                            ...
                            <h2 class="mb-0 fw-bold text-white"><?php echo e($productions->total()); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body d-flex align-items-center justify-content-between py-2">
                            ...
                            <div class="d-flex gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->level === 1 || auth()->user()->hasPermission('production.create')): ?>
            ...
            <div class="filter-section shadow-sm border-0 theme-responsive-card p-3 rounded-3">
                ...
                <div class="collapse mt-3" id="advancedTableFilters" wire:ignore.self>
                    <div class="p-3 bg-light rounded-3 bg-opacity-50">
                        <div class="row g-3">
                            <!-- Department Filter -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->level === 1 || auth()->user()->hasPermission('production.view.all')): ?>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select wire:model.live="filterWarehouse" class="form-select border-0 bg-white shadow-none rounded-3" <?php if(auth()->user()->id_warehouse && !auth()->user()->hasPermission('production.view.all')): ?> disabled <?php endif; ?>>
        ...
        <div class="col-12">
            <div class="table-responsive shadow-sm rounded-3">
                <table class="modern-table mb-0">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $productions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $production): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('production-{{ $production->id_production }}', get_defined_vars()); ?>wire:key="production-<?php echo e($production->id_production); ?>">
                            <td class="text-center text-muted small"><?php echo e(($productions->currentPage()-1) * $productions->perPage() + $loop->iteration); ?></td>
                            <td>
                                <a href="<?php echo e(route('production.show', hashid_encode($production->id_production, 'production'))); ?>" class="fw-bold text-primary text-decoration-none">
                                    <?php echo e($production->production_number ?? 'DRAFT'); ?>

                                </a>
                                <br>
                                <span class="text-muted small">
                                    <i class="ti ti-calendar me-1"></i><?php echo e($production->production_date ? \Carbon\Carbon::parse($production->production_date)->format('d M Y') : '-'); ?>

                                </span>
                            </td>
                            <td>
                                <div class="fw-bold modern-text-title text-uppercase"><?php echo e($production->departement->departement ?? '-'); ?></div>
                                <div class="text-muted small">
                                    <i class="ti ti-building me-1"></i><?php echo e($production->company->company_name ?? '-'); ?>

                                </div>
                            </td>
                            <td>
                                <div class="fw-semibold mb-1"><i class="ti ti-building-warehouse me-1 text-primary"></i><?php echo e($production->warehouse->warehouse_name ?? '-'); ?></div>
                                <div class="text-muted small"><i class="ti ti-user me-1"></i><?php echo e($production->user->name ?? '-'); ?></div>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-light-danger text-danger border border-danger-subtle ms-1" title="Materials (Bahan Baku)"><?php echo e($production->materials_count); ?> Mat</span>
                                <span class="badge bg-light-success text-success border border-success-subtle" title="Results (Barang Jadi)"><?php echo e($production->results_count); ?> Res</span>
                            </td>
                            <td class="text-center">
                                <?php
                                $statusBadge = [
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <button type="button"
                                        onclick="showConfirm({ title: 'Hapus Production', message: 'Apakah Anda yakin ingin menghapus Data ini secara keseluruhan (termasuk membatalkan mutasi stok)?', type: 'danger', onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').delete(<?php echo e($production->id_production); ?>) })"
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3549869008-0', $key);
...
<?php /**PATH D:\!Kerja\laracok - Copy\resources\views/livewire/production/index.blade.php ENDPATH**/ ?>