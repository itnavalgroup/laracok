            ...
            <div class="card edit-card">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="user-profile-header">
                        ...
                        <h3 class="mb-0 fw-bold"><?php echo e(auth()->user()->name); ?></h3>
                        <p class="mb-0 mt-1 small opacity-75">ID: <?php echo e(auth()->user()->id_employee); ?> | Level: <?php echo e(auth()->user()->level_detail->level_name ?? '-'); ?></p>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="d-flex align-items-center flex-column flex-md-row text-center text-md-start">
                            <div class="photo-preview-container mb-3 mb-md-0 shadow-sm rounded-circle me-md-4">
                                ...
                                <img src="<?php echo e(asset('storage/image/' . $photo)); ?>" class="h-100 w-100 object-fit-cover rounded-circle shadow-sm">
                                <?php else: ?>
                            ...
                            <div>
                                <h6 class="fw-bold mb-1"><?php echo e(auth()->user()->name); ?></h6>
                                <p class="modern-text-muted small mb-0"><?php echo e(auth()->user()->position->position ?? 'No Position Assigned'); ?></p>
                                <span class="badge <?php echo e(auth()->user()->is_active ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'); ?> rounded-pill mt-2">
                                    <?php echo e(auth()->user()->is_active ? 'ACCOUNT ACTIVE' : 'ACCOUNT INACTIVE'); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(auth()->user()->id_employee); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = auth()->user()->emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(auth()->user()->level_detail->level_name ?? '-'); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small">Department</label>
                                <input type="text" class="form-control" value="<?php echo e(auth()->user()->departement->departement ?? '-'); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small">Warehouse</label>
                                <input type="text" class="form-control" value="<?php echo e(auth()->user()->warehouse->warehouse_name ?? '-'); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small">Position</label>
                                <input type="text" class="form-control" value="<?php echo e(auth()->user()->position->position ?? '-'); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small">Supervisor</label>
                                <input type="text" class="form-control" value="<?php echo e(auth()->user()->boss->name ?? 'None'); ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section border-0">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->bankAccounts->isEmpty()): ?>
                        ...
                        <?php else: ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = auth()->user()->bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="card mb-3 border shadow-none bg-light-subtle rounded-3 overflow-hidden bank-account-card">
                            <div class="card-body p-3">
                                <h6 class="mb-3 fw-bold text-primary small">ACCOUNT #<?php echo e($index + 1); ?></h6>
                                <div class="row g-3">
                                    <div class="col-md-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 text-center">
                                <div class="photo-preview-container mx-auto mb-2 position-relative" style="width: 110px; height: 110px;">
                                    ...
                                    <?php elseif($photo): ?>
                                    <img src="<?php echo e(asset('storage/image/' . $photo)); ?>" class="h-100 w-100 object-fit-cover rounded-circle">
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="col-12">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="input-group mb-2">
                                    <span class="input-group-text"><i class="ti ti-mail text-muted"></i></span>
                                    <input type="email" class="form-control" wire:model="emails.<?php echo e($i); ?>.email" placeholder="user@example.com">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$email['isUsed'] && count($emails) > 1): ?>
                                    <button type="button" wire:click="removeEmail(<?php echo e($i); ?>)" class="btn btn-outline-danger btn-sm border-start-0" title="Remove">
                                        <i class="ti ti-trash"></i>
                                    </button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($email['isUsed']): ?>
                                    <span class="input-group-text text-warning small" title="Used in transactions"><i class="ti ti-lock"></i></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ["emails.{$i}.email"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger small d-block mb-1"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            ...
                            <div class="col-12">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="card mb-3 border bg-light-subtle rounded-3 overflow-hidden">
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="fw-bold text-primary small">ACCOUNT #<?php echo e($i + 1); ?></span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$bank['isUsed']): ?>
                                            <button type="button" wire:click="removeBankAccount(<?php echo e($i); ?>)"
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-4">
                                                <label class="form-label small text-muted mb-1">Bank Name</label>
                                                <input type="text" class="form-control form-control-sm" wire:model="bankAccounts.<?php echo e($i); ?>.nama_bank" placeholder="BCA, Mandiri...">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label small text-muted mb-1">Account Holder</label>
                                                <input type="text" class="form-control form-control-sm" wire:model="bankAccounts.<?php echo e($i); ?>.nama_penerima" placeholder="Full name">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label small text-muted mb-1">Account Number</label>
                                                <input type="text" class="form-control form-control-sm" wire:model="bankAccounts.<?php echo e($i); ?>.norek" placeholder="12345678">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
</div><?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\profile\edit.blade.php ENDPATH**/ ?>