    ...
    <script>
        function productionDetailData() {
            return {
                ...
                errorMsg: '',
                errors: {},
                matItems: <?php echo json_encode($matItems, 15, 512) ?>,
                resItems: <?php echo json_encode($resItems, 15, 512) ?>,
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\production\form-detail-modal.blade.php ENDPATH**/ ?>