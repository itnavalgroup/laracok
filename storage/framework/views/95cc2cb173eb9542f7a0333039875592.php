                    ...
                    <div class="card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="user-list-scroll" style="max-height: calc(100vh - 320px); overflow-y: auto;">
                                ...
                                <div wire:click="selectUser(<?php echo e($user->id_user); ?>)"
                                    class="user-list-item d-flex align-items-center p-3 border-bottom cursor-pointer <?php echo e($selectedUserId == $user->id_user ? 'bg-primary text-white' : ''); ?>"
                                    ...
                                    <div class="avatar-sm me-3 flex-shrink-0">
                                        ...
                                        <img src="<?php echo e(asset('storage/image/' . $user->photo)); ?>" class="rounded-circle" style="width:36px;height:36px;object-fit:cover;" alt="">
                                        <?php else: ?>
                                        <div class="rounded-circle d-flex align-items-center justify-content-center <?php echo e($selectedUserId == $user->id_user ? 'bg-white text-primary' : 'bg-primary-subtle text-primary'); ?>" style="width:36px;height:36px;font-size:14px;font-weight:700;">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <div class="fw-semibold text-truncate small"><?php echo e($user->name); ?></div>
                                        <div class="text-truncate" style="font-size:0.7rem; opacity:0.75;"><?php echo e($user->position->position ?? '-'); ?></div>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUserId == $user->id_user): ?>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-header py-3 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #1e3a5f, #2563eb);">
                            <div class="d-flex align-items-center gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUser->photo): ?>
                                <img src="<?php echo e(asset('storage/image/' . $selectedUser->photo)); ?>" class="rounded-circle border border-2 border-white" style="width:48px;height:48px;object-fit:cover;">
                                <?php else: ?>
                                <div class="rounded-circle bg-white text-primary d-flex align-items-center justify-content-center fw-bold" style="width:48px;height:48px;font-size:18px;">
                                    <?php echo e(strtoupper(substr($selectedUser->name, 0, 1))); ?>

                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="text-white">
                                    <h6 class="mb-0 fw-bold text-white"><?php echo e($selectedUser->name); ?></h6>
                                    <small class="opacity-75"><?php echo e($selectedUser->position->position ?? '-'); ?> • <?php echo e($selectedUser->departement->departement ?? '-'); ?></small>
                                </div>
                            </div>
                            <div class="d-flex gap-2">
                                <button type="button"
                                    onclick="showConfirm({
                                            ...
                                            message: 'Apakah Anda yakin ingin memberikan SEMUA hak akses ke user <?php echo e($selectedUser->name); ?>?',
                                            type: 'success',
                                            onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').grantAll()
                                        })"
                                ...
                                <button type="button"
                                    onclick="showConfirm({
                                            ...
                                            message: 'Apakah Anda yakin ingin mencabut SEMUA hak akses dari user <?php echo e($selectedUser->name); ?>?',
                                            type: 'danger',
                                            onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').revokeAll()
                                        })"
                            ...
                            <div class="d-flex gap-2">
                                <button type="button"
                                    onclick="showConfirm({
                                            ...
                                            type: 'danger',
                                            onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').revokeAllGlobal()
                                        })"
                        ...
                        <div class="card-body p-0" style="max-height: calc(100vh - 350px); overflow-y: auto;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $permissionsByModule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="permission-module-section">
                                ...
                                <div class="px-4 py-2 d-flex align-items-center justify-content-between module-header"
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="fw-bold text-primary small text-uppercase"><?php echo e($module); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUser): ?>
                                        <span class="badge bg-primary-subtle text-primary rounded-pill ms-1" style="font-size:0.65rem;">
                                            <?php echo e($permissions->filter(fn($p) => $userPermissions[$p->id_permission] ?? false)->count()); ?>
                                ...
                                <div class="d-flex align-items-center px-4 py-2 border-bottom permission-row"
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="fw-semibold small permission-desc"><?php echo e($permission->permission_description); ?></div>
                                        <code class="text-muted permission-name" style="font-size:0.7rem;"><?php echo e($permission->permission_name); ?></code>
                                    </div>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$selectedUser): ?>
                                    <!-- Management Mode Actions -->
                                    <div class="d-flex align-items-center gap-1 ms-3">
                                        <button wire:click="editPermission(<?php echo e($permission->id_permission); ?>)" class="btn btn-sm btn-icon btn-outline-primary border-0 action-btn" title="Edit Master">
                                            <i class="ti ti-edit fs-5"></i>
                                        </button>
                                        <button type="button"
                                            onclick="showConfirm({
                                                            title: 'Hapus Permission',
                                                            message: 'Apakah Anda yakin ingin menghapus permission <?php echo e($permission->permission_name); ?>? Ini akan menghapus master data dan mencabut akses dari SEMUA user.',
                                                            type: 'danger',
                                                            onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').deletePermission(<?php echo e($permission->id_permission); ?>)
                                                        })"
                                    ...
                                    <div class="form-check form-switch mb-0 ms-3">
                                        <input class="form-check-input"
                                            ...
                                            wire:click="togglePermission(<?php echo e($permission->id_permission); ?>)"
                                            <?php echo e(($userPermissions[$permission->id_permission] ?? false) ? 'checked' : ''); ?>>
                                    </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
            ...
            <div class="modal-content border-0 shadow-lg modal-dark-fix">
                <div class="modal-header bg-primary text-white py-3">
                    <h5 class="modal-title fw-bold text-white" id="permissionModalLabel">
                        <?php echo e($editingPermissionId ? 'Edit Permission' : 'Add New Permission'); ?>
                ...
                <form wire:submit.prevent="savePermission">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control modal-input <?php $__errorArgs = ['permissionForm.permission_name'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['permissionForm.permission_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control modal-input <?php $__errorArgs = ['permissionForm.permission_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['permissionForm.permission_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-0">
                            ...
                            <input type="text" class="form-control modal-input <?php $__errorArgs = ['permissionForm.module'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['permissionForm.module'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="modal-footer border-0 p-4 pt-0">
                        ...
                        <button type="submit" class="btn btn-primary px-4 rounded-pill">
                            <i class="ti ti-device-floppy me-1"></i> <?php echo e($editingPermissionId ? 'Update Permission' : 'Save Permission'); ?>
...
</div><?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\permissions\index.blade.php ENDPATH**/ ?>