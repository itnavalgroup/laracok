            ...
            <div class="card edit-card">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="user-profile-header">
                        ...
                        <h3 class="mb-0 fw-bold"><?php echo e($name); ?></h3>
                        <p class="mb-0 mt-1 small opacity-75">ID: <?php echo e($id_employee); ?> | Level: <?php echo e($levelName); ?></p>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="d-flex align-items-center flex-column flex-md-row text-center text-md-start">
                                <div class="photo-preview-container mb-3 mb-md-0 position-relative">
                                    ...
                                    <img src="<?php echo e(asset('storage/image/' . $existingPhoto)); ?>" class="h-100 w-100 object-fit-cover rounded-circle shadow-sm">
                                    <?php elseif($photo): ?>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" wire:model="id_employee" <?php echo e($canEditSecurity ? '' : 'readonly'); ?> placeholder="e.g. SBB-0000">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $emailItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div class="input-group <?php if(!$loop->last): ?> mb-2 <?php endif; ?> <?php if($emailItem['isUsed']): ?> locked-row <?php endif; ?>">
...
unset($__errorArgs, $__bag); ?>" wire:model="emails.<?php echo e($index); ?>.email" placeholder="example@navalgroup.com" <?php echo e($emailItem['isUsed'] ? 'readonly' : ''); ?>>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emailItem['isUsed']): ?>
...
unset($__errorArgs, $__bag); ?>" wire:model="level" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
...
unset($__errorArgs, $__bag); ?>" wire:model="id_departement" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
...
unset($__errorArgs, $__bag); ?>" wire:model="id_position" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" wire:model="supervisor" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
...
unset($__errorArgs, $__bag); ?>" wire:model="id_warehouse" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex gap-4 pt-1">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" id="active" value="1" wire:model="is_active" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
                                            <label class="form-check-label text-success fw-bold" for="active">Active</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" id="inactive" value="0" wire:model="is_active" <?php echo e($canEditSecurity ? '' : 'disabled'); ?>>
                        ...
                        <div class="form-section">
                            ...
                            <div class="card mb-3 border shadow-none bg-light-subtle rounded-3 overflow-hidden bank-account-card <?php if($bank['isUsed']): ?> locked-row <?php endif; ?>">
                                <div class="card-body p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <h6 class="mb-0 fw-bold text-primary small me-2">REKENING #<?php echo e($index + 1); ?></h6>
                                        ...
                                        <button type="button" class="btn btn-sm btn-light text-danger rounded-circle p-0" style="width: 28px; height: 28px;" wire:click="removeBankAccount(<?php echo e($index); ?>)" <?php echo e($bank['isUsed'] ? 'disabled' : ''); ?>>
                                            <i class="ti ti-trash"></i>
                                        </button>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-white" wire:model="bankAccounts.<?php echo e($index); ?>.nama_bank" placeholder="e.g. OCB / BCA" <?php echo e($bank['isUsed'] ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-white" wire:model="bankAccounts.<?php echo e($index); ?>.nama_penerima" placeholder="Full Name" <?php echo e($bank['isUsed'] ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-white" wire:model="bankAccounts.<?php echo e($index); ?>.norek" placeholder="Number only" <?php echo e($bank['isUsed'] ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mt-5 pt-4 border-top d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                            <div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditSecurity): ?>
                                <button type="button"
                                    onclick="showConfirm({
                                        title: 'Reset Password',
                                        message: 'Apakah Anda yakin ingin meriset password user ini ke default (12345678)?',
                                        type: 'danger',
                                        onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').resetPassword()
                                    })"
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <button type="button"
                                    onclick="showConfirm({
                                        ...
                                        type: 'primary',
                                        onConfirm: () => window.Livewire.find('<?php echo e($_instance->getId()); ?>').save()
                                    })"
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\users\edit.blade.php ENDPATH**/ ?>