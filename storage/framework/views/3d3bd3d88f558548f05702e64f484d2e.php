...
function contractFormData() {
    return {
        ...
        async save() {
            this.saving = true;
            this.errors = {};
            const result = await window.Livewire.find('<?php echo e($_instance->getId()); ?>').saveFromJs(this.form, this.contractId);
            this.saving = false;
            if (result) {
...
<?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\contracts\form-modal.blade.php ENDPATH**/ ?>