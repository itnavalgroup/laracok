<div class="modal fade" id="ikbFormModal" tabindex="-1" aria-labelledby="ikbFormModalLabel" aria-hidden="true"
    wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px;" x-data="ikbFormData()"
            x-init="initForm()">
            ...
            <div class="modal-body p-4" style="max-height: calc(100vh - 200px); overflow-y: auto;">
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Tipe Dokumen <span
                                    class="text-danger">*</span></label>
                            <select x-model="form.id_doc_type" class="form-select select2-ikb" id="ikb_doc_type">
                                <option value="">-- Pilih Tipe --</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $docTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($doc->id_doc_type); ?>"><?php echo e($doc->doc_type); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <span class="text-danger small" x-show="errors.id_doc_type"
                                x-text="errors.id_doc_type"></span>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Nomor Dokumen</label>
                            <input type="text" x-model="form.number" class="form-control" :disabled="isEditing"
                        ...
                        <div class="col-md-6">
                            ...
                            <select x-model="form.id_departement" class="form-select select2-ikb" id="ikb_departement"
                                <?php if(Auth::user()->level != 1): ?> disabled <?php endif; ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <select x-model="form.id_company" class="form-select select2-ikb" id="ikb_company">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($comp->id_company); ?>"><?php echo e($comp->company); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <span class="text-danger small" x-show="errors.id_company"
                                x-text="errors.id_company"></span>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="text-danger small" x-show="errors.id_warehouse"
                                x-text="errors.id_warehouse"></span>
                        </div>

                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Sales (Requestor) <span
                                    class="text-danger">*</span></label>
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Transaction Type <span
                                    class="text-danger">*</span></label>
                            <select x-model="form.id_ikb_transaction_type" class="form-select select2-ikb"
                                id="ikb_transaction_type">
                                <option value="">-- Pilih Tipe Transaksi --</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $transactionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($tt->id_ikb_transaction_type); ?>"><?php echo e($tt->transaction_type); ?>

                                    </option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <span class="text-danger small" x-show="errors.id_ikb_transaction_type"
                                x-text="errors.id_ikb_transaction_type"></span>
                        </div>

                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Customer <span
                                    class="text-danger">*</span></label>
                            ...
                            <span class="text-danger small" x-show="errors.id_vendor"
                                x-text="errors.id_vendor"></span>
                        </div>

                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Destination <span
                                    class="text-danger">*</span></label>
                            <input type="text" x-model="form.destination" class="form-control"
                                placeholder="Tujuan pengiriman...">
                            <span class="text-danger small" x-show="errors.destination"
                                x-text="errors.destination"></span>
                        </div>

                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-6">
                                    <label class="fw-bold small text-uppercase">Booking Date <span
                                            class="text-danger">*</span></label>
                                    <input type="date" x-model="form.booking_date" class="form-control">
                                    <span class="text-danger small" x-show="errors.booking_date"
                                        x-text="errors.booking_date"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" x-model="form.po_number" class="form-control"
                                placeholder="Opsional">
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">SO Number</label>
                            <input type="text" x-model="form.so_number" class="form-control"
                                placeholder="Opsional">
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">RI Number</label>
                            <input type="text" x-model="form.ri_number" class="form-control"
                                placeholder="Opsional">
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">SK Number</label>
                            <input type="text" x-model="form.sk_number" class="form-control"
                                placeholder="Opsional">
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">DO Number</label>
                            <input type="text" x-model="form.do_number" class="form-control"
                                placeholder="Opsional">
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-uppercase">Batch Number</label>
                            <input type="text" x-model="form.batch_number" class="form-control"
                                placeholder="Opsional">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer border-0 d-flex justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <button type="button" @click="submitForm()"
                        class="btn btn-primary rounded-pill px-5 fw-bold text-uppercase shadow-sm"
                        :disabled="saving">
        ...
        function ikbFormData() {
            return {
                ...
                async submitForm() {
                    ...
                    this.saving = true;
                    try {
                        const result = await window.Livewire.find('<?php echo e($_instance->getId()); ?>').saveFromJs(this.form, this.ikbId);
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\ikb\form-modal.blade.php ENDPATH**/ ?>