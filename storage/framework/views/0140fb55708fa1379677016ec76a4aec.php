<div class="container-fluid mt-4" style="max-width: 1000px;" wire:ignore.self>
    <div>
        <div class="card border-0 shadow-lg" style="border-radius: 12px;"
            ...
            <div class="card-header bg-primary text-white py-3">
                <h5 class="card-title fw-bold text-white text-uppercase m-0">
                    <i class="ti ti-plus me-2"></i>
                    <span x-text="isEditing ? 'Edit Settlement Report' : 'Create Settlement Report'"></span>
                </h5>
                <a href="<?php echo e(route('settlement-reports.index')); ?>" class="btn-close btn-close-white" aria-label="Close"></a>
            </div>
    ...
    <script>
        function srFormData() {
            return {
                ...
                initForm() {
                    // Initialize form from Livewire's $wire.initialData
                    const data = <?php echo json_encode($initialData, 15, 512) ?>;
                    this.isEditing = data.is_edit || false;
                    this.srId = data.id_pr_origin || null;
                    ...
                    if (data && Object.keys(data).length > 0) {
                        ...
                        if (this.form.id_cost_category) {
                            this.loadCostTypes(this.form.id_cost_category, this.form.id_cost_type);
                        }
                        if (this.form.id_vendor) {
                            this.loadVendorDetails(this.form.id_vendor, this.form.id_email_vendor, this.form.id_norek_vendor);
                        }
                    }
    ...
    <?php $__env->stopPush(); ?><?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\settlement-reports\form.blade.php ENDPATH**/ ?>