            ...
            <div class="modal-content">
                <div class="modal-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <h5 class="modal-title text-white fw-bold">
                        <i class="fas fa-<?php echo e($detailId ? 'edit' : 'plus-circle'); ?> me-2"></i>
                        <?php echo e($detailId ? 'Edit Item sr' : 'Tambah Item sr'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                placeholder="Masukkan deskripsi item..." <?php echo e($isViewOnly ? 'readonly' : ''); ?>></textarea>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['detail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" wire:model="bl_number" placeholder="BL Number (opsional)" <?php echo e($isViewOnly ? 'readonly' : ''); ?>>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-medium">Qty <span class="text-danger">*</span></label>
                            <input type="text" class="form-control <?php $__errorArgs = ['qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                id="detail-qty" value="<?php echo e($qty ? number_format((float)$qty, 2, ',', '.') : ''); ?>" placeholder="0,00" autocomplete="off" <?php echo e($isViewOnly ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" wire:model="id_uom" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                id="detail-price" value="<?php echo e($price ? number_format((float)$price, 2, ',', '.') : ''); ?>" placeholder="0,00" autocomplete="off" <?php echo e($isViewOnly ? 'readonly' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control"
                                id="detail-discount" value="<?php echo e($discount ? number_format((float)($discount ?: 0), 2, ',', '.') : ''); ?>" placeholder="0,00" autocomplete="off" <?php echo e($isViewOnly ? 'readonly' : ''); ?>>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch px-4">
                                <input class="form-check-input ms-0 me-2" type="checkbox" id="gross-check" onchange="updateFlags()" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
                            ...
                            <input type="hidden" id="gross-hidden" value="<?php echo e($gross); ?>">
                        </div>
                        <div class="col-md-6">
                            <div class="form-check form-switch px-4">
                                <input class="form-check-input ms-0 me-2" type="checkbox" id="progresif-check" onchange="handleProgresifChange()" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
                                <label class="form-check-label" for="progresif-check">
                                    <strong>progresif</strong> <small class="text-muted">(Tarif 5%-35%)</small>
                                </label>
                            </div>
                            <input type="hidden" id="progresif-hidden" value="<?php echo e($progresif); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="ppntype" onchange="loadTaxOptions('ppntype', 'ppn')" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
                                <option value="">Pilih Tipe PPN</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $taxTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($tt->id_tax_type); ?>"><?php echo e($tt->tax_type); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <input type="hidden" id="ppntype-hidden" value="<?php echo e($id_tax_type1); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-medium">PPN</label>
                            <select class="form-select" id="ppn" onchange="calculate()" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
                                <option value="">Pilih PPN</option>
                            </select>
                            <input type="hidden" id="ppn-hidden" value="<?php echo e($id_tax1); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Jumlah PPN</label>
                            <input type="text" class="form-control" id="tax1-display" value="<?php echo e(number_format((float)($tax1 ?: 0), 2, ',', '.')); ?>" readonly>
                            <input type="hidden" id="tax1-hidden" value="<?php echo e((float)($tax1 ?: 0)); ?>">
                        </div>

                        
                        <div class="col-md-3">
                            <label class="form-label fw-medium">Tipe PPh</label>
                            <select class="form-select" id="pphtype" onchange="loadTaxOptions('pphtype', 'pph')" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
                                <option value="">Pilih Tipe PPh</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $taxTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($tt->id_tax_type); ?>"><?php echo e($tt->tax_type); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <input type="hidden" id="pphtype-hidden" value="<?php echo e($id_tax_type2); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-medium">PPh</label>
                            <select class="form-select" id="pph" onchange="calculate()" <?php echo e($isViewOnly ? 'disabled' : ''); ?>>
                                <option value="">Pilih PPh</option>
                            </select>
                            <input type="hidden" id="pph-hidden" value="<?php echo e($id_tax2); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-medium">DPP PPh</label>
                            <input type="text" class="form-control" id="dpp-pph"
                                value="<?php echo e($dpp_pph ? number_format((float)$dpp_pph, 2, ',', '.') : ''); ?>"
                                placeholder="0" autocomplete="off" <?php echo e($isViewOnly ? 'readonly' : ''); ?>>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-medium">Jumlah PPh</label>
                            <input type="text" class="form-control" id="tax2-display" value="<?php echo e(number_format((float)($tax2 ?: 0), 2, ',', '.')); ?>" readonly>
                            <input type="hidden" id="tax2-hidden" value="<?php echo e((float)($tax2 ?: 0)); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center p-3 rounded" style="background: linear-gradient(135deg, #3b82f6, #1d4ed8);">
                                ...
                                <span class="text-white fw-bold fs-4" id="amount-display"><?php echo e(number_format((float)($ammount ?: 0), 2, ',', '.')); ?></span>
                            </div>
                            <input type="hidden" id="amount-hidden" value="<?php echo e((float)($ammount ?: 0)); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer bg-light">
                    <button type="button" class="btn btn-secondary" wire:click="closeModal">
                        <i class="fas fa-times me-1"></i> <?php echo e($isViewOnly ? 'Tutup' : 'Batal'); ?>

                    </button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isViewOnly): ?>
                    <button type="button" class="btn btn-primary px-4" onclick="submitFormDetail()">
                        <i class="fas fa-save me-1"></i> <?php echo e($detailId ? 'Perbarui' : 'Simpan'); ?>
    ...
    <script>
        (function() {
            ...
            window.submitFormDetail = function() {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').syncAndSave(qty, price, discount, dppVal, ppntype, ppn, tax1, pphtype, pph, tax2, amount, gross, progresif);
            };
            ...
            document.addEventListener('livewire:updated', function() {
                var qtyEl = document.getElementById('detail-qty');
                if (qtyEl && !qtyEl.dataset.qtyBound) {
                    window._initFormDetailModal();
                }
            });

            document.addEventListener('livewire:initialized', function() {
                // Setiap kali modal SR dibuka, init ulang form
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH D:\!Kerja\laracok - Copy\resources\views\livewire\settlement-reports\form-detail-modal.blade.php ENDPATH**/ ?>